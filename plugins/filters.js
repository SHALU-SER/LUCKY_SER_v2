...
await message.client.sendMessage(message.jid, fs.readFileSync('./Abu/uploads/mention.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }

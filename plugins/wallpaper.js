...
if (Config.WORKTYPE == 'private') {
    ...
    Julie.addCommand({pattern: 'wallpaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid, Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '💖ᴄʀᴇᴀʀᴇᴅ ʙʏ➡️ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝✰ͣᴀͫʙᴜ ʙᴏᴛ ✰💖```'})
